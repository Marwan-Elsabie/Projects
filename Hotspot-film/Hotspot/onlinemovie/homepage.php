              ...
              echo"<h1 style='color:black;position:sticky;'>WELCOME </h1><b style = 'color: black;font-size: 25px'><i> ".ucwords($rel['name'])." !</i></b>
                ...
                <div class='row'>
                  <div class='col'>
                    ...
                    <input type='submit' name='submit' class='btn btn-danger' style='display:inline;width:400px;margin-left:20px;margin-right:20px;' value='".ucwords($rel2['name'])."'/></h3>
                    </form>
                  </div>
                  <div class='col'>
